...
def crawleappsByCaseId(caseId, isGenerateJson):
    result = {}
    try:
        url = 'https://eapps.courts.state.va.us/cav-public/caseInquiry/showCasePublicInquiry?caseId'
        values = {"caseId": caseId}
        headers = {'Cookie': 'JSESSIONID=0000ZRWCvFtTH5Kz2JlSKksfY3v:1962kbr3k', 'Host': 'eapps.courts.state.va.us',
        ...
        cavRecordInput = soup.find('input', id='caseNumber')
        cavRecordNumber = cavRecordInput['value'].strip()
